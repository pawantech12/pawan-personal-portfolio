...
const Skill = () => {
  return (
    <div className="w-8/12 bg-white shadow-md rounded-xl py-7 px-8">
      <ul className=" px-5 ">
        <li className="list-disc text-xl font-medium text-neutral-700">
          Skills
        </li>
      </ul>
      <div className="flex gap-5 flex-wrap justify-center mt-4">
        <div className="skillCard rounded-xl p-5 shadow-lg w-32 border border-gray-100 flex flex-col items-center gap-2">
