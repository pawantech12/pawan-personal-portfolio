...
const Skill = () => {
  return (
    <div className="flex justify-center mt-7">
      <div className="w-8/12 bg-neutral-800 shadow-md rounded-xl py-7 px-8">
        <ul className=" px-5 ">
        ...
        <div className="flex gap-5 flex-wrap justify-center mt-4">
          <div className="skillCard rounded-xl p-5 shadow-lg w-32 bg-zinc-900 text-white flex flex-col items-center gap-2">
